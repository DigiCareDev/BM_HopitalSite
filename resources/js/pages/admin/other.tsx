...
function Other() {
    ...
    const deleteContact = async (id) => {
        ...
        try {
            ...
            if (res.ok) {
                setOther((prev) => prev.filter((item) => item.id !== id));
    ...
    const handleDownloadCSV = () => {
        ...
        const headers = ["#", "Name", "Email", "Phone", "Subject", "Message"];
                ...
                <table className="min-w-full table-auto divide-y divide-gray-200 text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100 text-gray-700">
                        ...
                        {loading ? (
                            ...
                            <tr>
                                <td className="text-center text-gray-500 py-4">No other found.</td>
                            </tr>
                        ) : (
                            other.map((item, i) => (
                                <tr key={item.id} className="hover:bg-blue-50 transition-all">
                                    ...
                                    <td className="px-2 py-2">{item.subject || 'N/A'}</td>
