...
function Specialities({ translations }) {
    ...
    const specialities = [
        ...
        },
        {
            ...
            link: '/departments',
            name: translations?.emergency_medicine,
        ...
        },
        {
            ...
            link: '/departments',
            name: translations?.gastroenterology,
        ...
        },
        {
            ...
            link: '/departments',
            name: translations?.general_surgery,
