...
function QuickEnquiry() {
    ...
    const handleEnquirySubmit = async (e) => {
            ...
            try {
                const res = await fetch('http://emarketplace.progatetechnology.com/api/enquiries', {
                    method: 'POST',
                    headers: {
                ...
                try {
                    ...
                    if (res.ok) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Submitted!',
                            text: data.message || "Enquiry saved successfully!",
                            timer: 3000,
                        });
                        setEnquiry({
                            name: '',
    ...
    return (
        <div>
            <form onSubmit={handleEnquirySubmit} className="space-y-4 border-y-4 border-blue-700 text-blue-700 p-4 rounded-md shadow-xl">
                <div>
