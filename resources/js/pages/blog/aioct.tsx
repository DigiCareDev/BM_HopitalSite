...
function Aioct({ blog }) {
  ...
  return (
    <div className='bg-white'>
      ...
      <div className="max-w-4xl mx-auto p-6 my-5 bg-white rounded-xl shadow-lg border border-gray-200">
        <h1 className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-2 leading-snug">{blog.title}</h1>
        ...
        <div className="text-base text-gray-800 leading-relaxed space-y-6">
          <div>
            <h2 className="text-xl font-semibold text-blue-700 mb-2">Blog Description</h2>
          ...
          {blog.description && (
            <div>
              ...
              <div
                className="prose max-w-none prose-blue prose-sm md:prose-base"
