                    ...
                    <div className="max-w-8xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
                            {loading ? (
                                ...
                                >
                                    <img
                                        src={blog.image ? `${devURL}/storage/${blog.image}` : Logo}
                                        alt='title'
                                    ...
                                    <div className="p-5">
                                        ...
                                        <p className="text-gray-600 text-sm mb-4">  {stripHtml(blog.subtitle).slice(0, 200)}...</p>
                                        ...
                                        <a
                                            href={route('ai-oct.show', blog.id)}
